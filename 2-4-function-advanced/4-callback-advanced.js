...
// 서울, 서울 또는 부산 등 요구조건이 매우 다양할 수 있다.
// 여기서 등장하는게 콜백 함수
...
const newArray2 = filterByUserLiveInRegion('서울');
...
const filter6 = filter(names, name => name[0] === '김');
console.log(filter6);
