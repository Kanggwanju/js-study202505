...
function increaseClosure() {
  ...
  return {
    increaseCount: () => ++count,
    // increaseCount: increaseCount 이므로 increaseCount로 줄일 수 있음.
    decreaseCount: () => --count
  };
}
...
// increaseCount를 increaseHobbyCount로 디스트럭쳐링
...
// const decreaseHobbyCount = decreaseCount;
...
// const decreaseFriendCount = decreaseCount;
