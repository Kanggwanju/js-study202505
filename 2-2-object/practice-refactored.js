/*
  practice-refactored.js

  이 파일은 로그인 기능 실습 코드의 개선된 버전입니다.
  - 계정과 비밀번호 검증 로직을 객체 중심으로 리팩토링하였고,
  - 불필요한 배열 분리를 제거하여 코드의 가독성과 유지보수성을 향상시켰습니다.
  - 흐름 제어에 continue와 break를 활용하여 논리 흐름을 간결하게 구성하였습니다.

  원본 실습 코드 대비 구조적 개선을 중심으로 작성된 예시입니다.
*/
