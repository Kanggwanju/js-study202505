...
// console.log(article1.title); 아래와 동일
...
console.log(article1.writer.emailVerify && false); // boolean, false
...
// 소스코드를 통해 프로퍼티를 추가 가능
// 프로퍼티가 없으면 추가, 있으면 수정으로 기능한다.
person.bloodType = 'AB';
console.log(person);
person.bloodType = 'O';
